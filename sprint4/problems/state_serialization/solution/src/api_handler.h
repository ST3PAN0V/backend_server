...
class ApiHandler {
public:
    explicit ApiHandler(net::io_context& ioc, model::Game& game, App& app, StateStorage& storage, loot::Generator& loot_generator, loot::Data& loot_data, int tick_period = 0) 
    : game_(game)
    , app_(app)
    , storage_(storage)
